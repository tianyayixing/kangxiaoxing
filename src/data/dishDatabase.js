...
export const initialDishDatabase = [
  ...
  { id: 34, name: '红烧肉', category: '家常菜', calories: 350, protein: 18, fat: 28, carbs: 12, fiber: 0, vitaminC: 0, vitaminB: 15, image: '🍖', cookingMethod: '炖煮入味', effect: '高热量，偶尔食用' },
  ...
  { id: 63, name: '糖醋里脊', category: '家常菜', calories: 280, protein: 18, fat: 15, carbs: 22, fiber: 1, vitaminC: 5, vitaminB: 10, image: '🍖', cookingMethod: '炸后炒制', effect: '高热量，偶尔食用' },
  ...
  { id: 65, name: '回锅肉', category: '家常菜', calories: 320, protein: 16, fat: 26, carbs: 10, fiber: 1, vitaminC: 8, vitaminB: 12, image: '🥓', cookingMethod: '煮后炒制', effect: '高脂高热，偶尔食用' },
  ...
  { id: 81, name: '炒豆芽', category: '蔬菜', calories: 30, protein: 2, fat: 0.5, carbs: 5, fiber: 1.5, vitaminC: 20, vitaminB: 10, image: '🌱', cookingMethod: '快炒', effect: '低热量，清热解毒' },
  { id: 82, name: '炒空心菜', category: '蔬菜', calories: 35, protein: 2.5, fat: 1, carbs: 5, fiber: 2.2, vitaminC: 25, vitaminB: 8, image: '🥬', cookingMethod: '大火快炒', effect: '清热解毒，通便' },
  ...
  // 更多营养餐
  { id: 97, name: '鸡肉沙拉', category: '沙拉', calories: 145, protein: 22, fat: 5, carbs: 6, fiber: 2, vitaminC: 15, vitaminB: 18, image: '🥗', cookingMethod: '鸡肉配蔬菜', effect: '低脂高蛋白，减脂' },
  { id: 98, name: '蔬菜沙拉', category: '沙拉', calories: 65, protein: 2, fat: 3, carbs: 8, fiber: 3, vitaminC: 35, vitaminB: 8, image: '🥗', cookingMethod: '生菜配调料', effect: '低热量，富含维生素' },
  { id: 99, name: '水果沙拉', category: '水果', calories: 85, protein: 1, fat: 2, carbs: 18, fiber: 3, vitaminC: 45, vitaminB: 6, image: '🍇', cookingMethod: '切块混合', effect: '补充维生素，抗氧化' },
  { id: 100, name: '牛排', category: '肉类', calories: 271, protein: 26, fat: 18, carbs: 0, fiber: 0, vitaminC: 0, vitaminB: 35, image: '🥩', cookingMethod: '煎至理想熟度', effect: '高蛋白，补铁' },
];
